...
class ResepObatController extends Controller
{
    ...
    function get(Request $request)
    {
        ...
        if ($request->no_resep) {
            $resepObat = ResepObat::where(['no_resep' => $request->no_resep])->with('resepDokter.obat.satuan',
            'resepRacikan.detail.obat.satuan', 'resepRacikan.metode')->first();
        } else {
    ...
    function print(Request $request)
    {
        ...
        $resepObat = ResepObat::where(['no_rawat' => $request->no_rawat])->with('resepDokter.obat', 'resepRacikan.detail.obat.satuan', 'dokter')->first();
